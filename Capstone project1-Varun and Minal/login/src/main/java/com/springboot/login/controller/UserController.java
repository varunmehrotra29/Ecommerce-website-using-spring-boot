...
public class UserController {
	...
	public String login(Model model, String email, String password) {
		String msg = "";
		try {
			Map<Users, String> map = user.login(email, password);
	...
	@GetMapping("/all")
	public CartInformation getAllinfo(){
		
		List<Users> cartinfo= user.findAll();
	...
	public String signup(String mobile, Users u1, Model model) {
